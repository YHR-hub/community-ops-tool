...
class AIMixin:
    ...
    def _build_ai(self):
        ...
        self.ai_base = ctk.CTkEntry(row2, width=350, placeholder_text="https://api.deepseek.com")
        self.ai_base.pack(side="left", padx=5)
        self.ai_model = ctk.CTkOptionMenu(row2, values=["deepseek-chat", "deepseek-v4-pro", "gpt-4o-mini", "gpt-4o", "gpt-3.5-turbo"], width=150)
        ...
        # 预设场景
        scene_frame = ctk.CTkFrame(self.main_frame, fg_color=MHY_CARD, corner_radius=12,
                                    border_width=1, border_color=MHY_BORDER)
        scene_frame.pack(fill="both", expand=True, padx=30, pady=(0, 20))
        ...
        self.ai_result.pack(fill="both", expand=True, padx=15, pady=(0, 15))
